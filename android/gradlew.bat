...
:execute
@rem Java version guard removed here because this repository uses Java from Android Studio JBR and
@rem the previous parser failed on Windows paths with spaces ("C:\Program Files\...").
